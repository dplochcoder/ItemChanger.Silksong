...
internal class SongclaveShopTest : Test
{
    ...
    public override void Setup(TestArgs args)
    {
        ...
        Profile.AddPlacement(Finder.GetLocation(LocationNames.Jubilana__Requires_Rescue)!.Wrap().Add(Finder.GetItem(ItemNames.Cling_Grip)!.WithCost(new RosaryCost(2))));
    }
