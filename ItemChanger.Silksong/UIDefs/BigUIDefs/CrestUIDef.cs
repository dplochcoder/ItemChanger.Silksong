...
public class CrestUIDef : ControlRelinquishedUIDef
{
    ...
    public AssetCache.GameObjectKey PrefabKey { get; init; } = GameObjectKeys.CREST_GET_PROMPT();
    ...
    public static CrestUIDef Create(string id, UIDef fallback, AssetCache.GameObjectKey? prefabKey = null)
    {
        ...
        return new() { Crest = crestProvider, Fallback = fallback, PrefabKey = prefabKey ?? GameObjectKeys.CREST_GET_PROMPT() };
    }
}
