...
public class SkynxShopPlacement(string Name) : Placement(Name), IPrimaryLocationPlacement, IMultiCostPlacement
{
    ...
    protected override void DoLoad()
    {
        ...
        SilksongHost.Instance.ActiveProfile?.Modules.GetOrAdd<StyxAndSkynxModule>()?.RegisterPlacement(this);
    }

    protected override void DoUnload()
    {
        SilksongHost.Instance.ActiveProfile?.Modules.Get<StyxAndSkynxModule>()?.UnregisterPlacement(this);
