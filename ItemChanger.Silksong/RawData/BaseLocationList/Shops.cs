...
internal static partial class BaseLocationList
{
    ...
    public static ShopLocation Frey__Requires_Bellhome => Frey_Base(LocationNames.Frey__Requires_Bellhome, new PDBool(nameof(PlayerData.BelltownHouseVisited)));

    public static ShopLocation Grindle => new()
    {
        SceneName = SceneNames.Coral_42,
        Name = LocationNames.Grindle,
    ...
    public static JubilanaShopLocation Jubilana__Requires_Rescue => Jubilana_Base(LocationNames.Jubilana__Requires_Rescue, new QuestCompletionBool(Quests.Save_City_Merchant_Bridge));
    ...
    public static ShopLocation Twelfth_Architect__Requires_Tools => Twelfth_Architect_Base(LocationNames.Twelfth_Architect__Requires_Tools);
